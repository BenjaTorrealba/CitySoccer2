            ...
            <div className={` max-w-5xl p-8 border-solid border-b-2 border-white border-opacity-30 mx-auto `}>
                <div className={` text-white text-left mx-auto`}> {/*  grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 */}
                    ...
                    <address>
                        ...
                        */}
                        <p className={` not-italic text-sm font-NotoSerif `}><Link href='mailto:citysoccersantiago@gmail.com'>citysoccersantiago@gmail.com</Link></p>
                    </address>
                    {/*
                    <address>
...
*/}
            ...
            <div className={` max-w-5xl p-8 mx-auto `}>
                <div className={` text-white text-left mx-auto `}>
                    Todos los derechos reservados a City Soccer 2025
                </div>
            </div>
